    ...
    <div class="max-w-4xl mx-auto mt-8">
        ...
        <form method="POST" action="{{ url('/users/' . $user->id) }}"
            ...
            <div class="bg-gray-50 px-4 py-3 rounded-t mb-6">
                ...
                <div class="mb-8">
                    <label for="password" class="block text-gray-700 font-bold mb-2">Cambiar Contraseña:</label>
                    <div class="relative">
                        <input type="password" name="password" id="password" placeholder="Cambiar Contraseña"
                               class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                ...
                <div class="mb-8">
                    <div class="flex items-center space-x-2">
                        ...
                        <input type="checkbox" id="is_admin" name="is_admin" class="hidden peer" value="1" {{$user->is_admin ? 'checked' : ''}}>
                        <label for="is_admin"
                ...
                <div class="mb-8">
                    <div class="flex items-center space-x-2">
                        ...
                        <input type="checkbox" id="verificado" name="verificado" class="hidden peer" value="1" {{$user->verificado ? 'checked' : ''}}>
