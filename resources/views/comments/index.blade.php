    ...
    <div class="bg-gray-100 rounded-lg shadow-md p-6">
        ...
        @if($table_data->isEmpty())
            ...
            <div class="mb-4 mt-8 ml-32 pr-36 text-center">
                <form method="get" action="{{ url('/comments/create') }}">
                    <button
                            ...
                            <td class="px-6 py-4 text-gray-900 relative">
                                <div x-data="{ open: false }" class="relative">
                                    ...
                                    <div x-show="open" x-cloak @click.away="open = false"
                                        ...
                                        <ul class="py-1">
                                            <li><a href="{{ url('/comments/' . $data->id . '/edit') }}"
                                                   class="block px-4 py-2 text-sm text-gray-700 text-center hover:bg-gray-100">Editar</a>
                                            </li>
                                            <li>
                                                <form method="POST"
                                                      action="{{ url('comments/' . $data->id) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
